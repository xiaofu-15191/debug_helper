...
void debug_helper::menubar_init()
{
	...
	run_action=new QAction("运行",nullptr);
	run_action->setShortcut(tr("F10"));
	connect(run_action,&QAction::triggered,this,&debug_helper::run);
...
void debug_helper::main_init()
{
	...
	//run button
	run_button=new QPushButton("运行(F10)",this);
	run_button->setIcon(QIcon(":/debug_helper/icons/run-tb.png"));
	run_button->setSizePolicy(QSizePolicy::Expanding,QSizePolicy::Expanding);
	connect(run_button,&QPushButton::clicked,this,&debug_helper::run);
	//compile and run button
	compile_and_run_button=new QPushButton("编译运行(F11)",this);
	compile_and_run_button->setIcon(QIcon(":/debug_helper/icons/compile-run-tb.png"));
	...
	debug_viewer->setFont(QFont("Fira Code,Microsoft Yahei"));
...
void debug_helper::compare()
{
	...
	compare_text_browser->setFont(QFont("Fira Code,Microsoft Yahei"));
...
void debug_helper::breakpoint_select()
{
	...
	breakpoint_input->setFont(QFont("Fira Code,Microsoft Yahei"));
	breakpoint_window_button->resize(500,50);
	breakpoint_window_button->move(50,400);
	breakpoint_window_button->setFont(QFont("Fira Code,Microsoft Yahei"));
